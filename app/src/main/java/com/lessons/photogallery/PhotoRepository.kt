...
import com.lessons.photogallery.api.PhotoInterceptor
...
class PhotoRepository {
    ...
    suspend fun searchPhotos(query:String):List<GalleryItem> = flickrApi.searchPhoto(query).photos.galleryItems
}